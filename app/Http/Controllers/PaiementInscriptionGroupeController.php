...
class PaiementInscriptionGroupeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.paiement_groupe_inscription.index',compact('chemin_theme_actif','nom','avatar','annee_courante','all_annee','eleve','all_eleves'));
    }
