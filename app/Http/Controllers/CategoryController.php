...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.category/index',compact('chemin_theme_actif','nom','avatar','annee_courante','all_annee','all_categories','i'));
    }
    ...
    {
        //
        $update_categorie = Category::where('id',$id)->update([
                                                                'libelle' => $request->libelle
                                                              ]);
    ...
    public function destroy($id)
    {
        ...
        $delete_categorie = Category::where('id',$id)->delete();
