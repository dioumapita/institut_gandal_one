...
class ArriererController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.arrierers/index',compact('chemin_theme_actif','nom','avatar','annee_courante','all_annee','all_inscriptions','all_niveaux'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $ancien_versement = Arrierer::where('eleve_id',$request->eleve_id)->where('annee_id',$id_annee)
                                      ->first()->montant_rembourser;

        $update_versement = Arrierer::where('eleve_id',$request->eleve_id)->where('annee_id',$id_annee)
                                    ->update([
                                                'montant_rembourser' => ($ancien_versement + $request->montant)
                                            ]);
    ...
    public function show($id)
    {
        ...
        return view('pages.arrierers/show',compact('chemin_theme_actif','nom','avatar','annee_courante','all_annee','all_inscriptions','all_niveaux','niveau_choisit'));
    }
    ...
    public function update(Request $request, $id)
    {
         ...
         */
        $id_annee = DB::table('annee')->latest('id')->first()->id;
        $update_versement = Arrierer::where('eleve_id',$id)->where('annee_id',$id_annee)
                                    ->update([
