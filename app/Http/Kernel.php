...
use App\Http\Middleware\LicenceKey;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        /**
         * middleware utiliser pour verfier si la licence est valide ()
         */
        'licence.key' => \App\Http\Middleware\LicenceKey::class,
        ...
        /**
         * middleware utiliser pour gérer les roles et les permissions
         */
