    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="#">
                ...
                <span class="logo-default">I. GANDAL</span> </a>
        </div>
        <!-- logo end -->
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <!-- end mode plein ecran -->
                <!-- start language menu -->
                {{-- <li class="dropdown language-switch">
                    @if(LaravelLocalization :: getCurrentLocaleName () == 'French')
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="/assets/asset_principal/img/flags/ru.png" alt=""> Français <span
                            class="fa fa-angle-down"></span>
                        </a>
                    @else
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="/assets/asset_principal/img/flags/gb.png" alt=""> Anglais <span
                                class="fa fa-angle-down"></span>
                        </a>
                    @endif
                            ...
                            <li>
                                @if($localeCode == 'fr')
                                    <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        <img src="/assets/asset_principal/img/flags/ru.png" alt=""> {{ $properties['native'] }}
                                    </a>
                                @else
                                    <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        <img src="/assets/asset_principal/img/flags/gb.png" alt=""> {{ $properties['native'] }}
                                    </a>
                                @endif
                            </li>
                        @endforeach
