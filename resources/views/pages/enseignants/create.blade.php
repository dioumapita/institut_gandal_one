    ...
    @section('content')
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Inscriptions Des Enseignants</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Inscriptions Des Enseignants</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-head">
                        <header>Inscriptions Des Enseignants</header>
                    </div>
                    <div class="card-body ">
                        <form id="inscriptions-enseignants" method="POST" action="{{ route('enseignant.store') }}" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <h3>Etape1/3</h3>
                            <fieldset>
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    <select class="form-control input-height" name="civilite">
                                                        ...
                                                        <option value="Mademoiselle" @if(old('civilite') == "Mademoiselle") selected @endif >Mademoiselle</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        class="form-control @error('quartier') is-invalid @enderror" value="{{ old('quartier') }}"
                                                        required>
                                                        @error('quartier')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong id="msg_error_profil">{{ $message }}</strong>
                                ...
                                <fieldset>
                                    <div class="col-lg-12 p-t-20">
                                        <div class="form-group col-md-6 mx-auto">
                                          ...
                                          <textarea class="form-control" name="diplome_obtenu" id="" cols="5" rows="5"></textarea>
                                        </div>
                                    </div>
                                </fieldset>
                        </form>
