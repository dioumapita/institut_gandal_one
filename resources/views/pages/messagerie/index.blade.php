...
<div id="media_screen" class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Gestion Des Messages</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                    href="{{ route('home') }}">Accueil</a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li><a class="parent-item" href="#">Messages</a>&nbsp;<i class="fa fa-angle-right"></i>
            </li>
            <li class="active">Gestion Des Messages</li>
        </ol>
    </div>
</div>
<div id="media_screen" class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>Gestion Des Messages</header>
                <div class="tools">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div  class="modal-header btn btn-danger text-center text-white">
                                            <h4 class="modal-title white-text w-100 font-weight-bold py-2">Nouveau Message</h4>
                                            ...
                                            <div class="modal fade" data-backdrop="static" id="nouveau{{$depense->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <!-- start modal body -->
                                                            <div class="modal-body">
                                                                <form action="{{ route('depense.update',$depense->id) }}" method="post">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('PUT') }}
                                                                    <div class="form-group">
                                                                        <label for="depense">Dépense</label>
                                                                        <input type="text" name="depense" id="depense" class="form-control" value="{{ $depense->depense }}" placeholder="Entrez la depense" required>
                                                                    </div>
                                                                    <div class="form-group">
