...
@extends($chemin_theme_actif,['title' => 'Enseignant-En-Regle-De-Paiement'])
@section('content')
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">les Enseignants En Règle De Paiement</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">Les Enseignants En Règle De Paiement</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-topline-red">
                <div class="card-head">
                    <header>Les Enseignants En Règle De Paiement</header>
                    <div class="tools">
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('retard_paiement_enseignant') }}" id="addRow"
                                    ...
                                    Les enseignants en rétard de paiement
                                </a>
                            </div>
                        </div>
                    </div>
