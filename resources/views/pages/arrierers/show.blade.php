@extends($chemin_theme_actif,['title' => 'Arriere-Par-Classe'])
@section('content')
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Gestion Des Arriérés D'une Classe</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Gestion Des Arriérés D'une Classe</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>Gestion Des Arriérés De La {{ $niveau_choisit->nom_niveau.' '.$niveau_choisit->options }}</header>
                <div class="tools">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-6">
                        <div class="btn-group">
                            <a href="{{ route('arrierer.index') }}" id="addRow"
                                class="btn btn-info">
