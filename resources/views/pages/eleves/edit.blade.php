...
@extends($chemin_theme_actif,['title' => 'eleves-edit-inscription'])
@section('content')
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">@lang('create.ModifInfosEleve')</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">@lang('create.ModifInfosEleve')</li>
            </ol>
        </div>
    </div>
    <a href="{{ route('eleve.index') }}" class="btn btn-primary"><i class="fa fa-reply"></i> @lang('liste_eleve.Retour')</a>
    <br><br>
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <div class="card-head">
                    <header>@lang('create.ModifInfosEleve')</header>
                </div>
                <div class="card-body ">
                    <form id="example-advanced-form" method="POST" action="{{ route('eleve.update',$eleve) }}" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <input type="text" name="matricule" minlength="6" placeholder="Veuillez saisir le matricule de l'élève"
                                                    class="form-control input-height @error('matricule') is-invalid @enderror" value="{{ $eleve->matricule }}" required />
                                                    @error('matricule')
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control input-height"
                                                    name="date_naissance" id="date_naissance" value="{{ $eleve->date_naissance->format('Y-m-d') }}"
                                                    class="floating-label mdl-textfield__input" placeholder="Date de naissance de l'étudiant" required>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <select class="form-control input-height" name="classe">
                                                    ...
                                                    @foreach ($all_classes as $classe)
                                                        <option value="{{ $classe->id }}" @if($classe->id == $niveau_courant->niveau_id) selected @endif>{{ $classe->nom_niveau.' '.$classe->options }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control input-height"
                                                    name="frais_inscription" placeholder="Veuillez saisir les frais d'inscriptions" value="{{ $niveau_courant->frais_inscription }}" required>
                                            </div>
                                        </div>
                                    </div>
                                <!-- End Quartier -->
