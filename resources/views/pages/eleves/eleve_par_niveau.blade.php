...
@extends($chemin_theme_actif,['title' => 'Eleves_Par_Classe'])
@section('content')
    <div class="page-bar">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-topline-red">
                <div class="card-head">
                    <header>@lang('liste_eleve.ListeDesEleves') @lang('liste_eleve.De') @lang('liste_eleve.la') {{ $niveau_choisit->nom_niveau.' '.$niveau_choisit->options }} (Nbre D'élève: {{$all_inscriptions->count()}}  )</header>
                    <div class="tools">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-6">
                            ...
                            {{-- <a id="imprimer" href="#" class="btn btn-primary"><i class="fa fa-print"></i> Imprimer la liste des élèves de la {{  $niveau_choisit->nom_niveau.' '.$niveau_choisit->options }}</a> --}}
                            <input type="button" class="btn btn-primary" onclick="printDiv('imprime')" value="@lang('liste_eleve.PrintListParClasse') {{  $niveau_choisit->nom_niveau.' '.$niveau_choisit->options }}" />
                        </div>
                        <div class="col-md-6 col-sm-6 col-6">
                            <div class="btn-group pull-right">
                                <label for="classe" class="control-label">@lang('liste_eleve.Classe') &nbsp;</label>
                            ...
                            <tbody>
                                @foreach ($all_inscriptions as $inscription)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{ $inscription->eleve->telephone_parent }}</td>
                                        <td>
                            ...
                            <div class="mx-auto col-md-12 col-sm-12 col-lg-12">
                                <div class="cercle">
                                    <div class="text-center">
                                        <h4 class="font-bold addr-font-h4">
                                            <u class="souligner">@lang('liste_eleve.ListeDesEleves')
                                               @lang('liste_eleve.De') @lang('liste_eleve.la') {{ $niveau_choisit->nom_niveau.' '.$niveau_choisit->options }}
                                             <br>
                        ...
                        <div>
                            ...
                            <div>
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="text-center" id="bordure_table">@lang('liste_eleve.Total')</td>
                        ...
                        <div>
                            <table id="bordure_table" class="table table-bordered">
                                ...
                                <tbody id="bordure_table">
                                    @foreach ($all_inscriptions as $inscription)
                                        <tr id="bordure_table">
                                            {{-- <td class="text-center" id="bordure_table"><img src="/images/photos/eleves/{{ $inscription->eleve->photo_profil }}" width="180px" height="120px" alt="" srcset=""> </td> --}}
