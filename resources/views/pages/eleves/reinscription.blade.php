    ...
    @section('content')
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">@lang('create.Reinscription_eleve')</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">@lang('create.Reinscription_eleve')</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-12 col-md-12 col-lg-12">
                <div class="card-box">
                    <div class="card-head">
                        <header>@lang('create.Reinscription_eleve')</header>
                    </div>
                    <div class="card-body ">
                        <form id="example-advanced-form" method="POST" action="{{ route('eleve.store') }}" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <h3>@lang('create.Quartier')3/5</h3>
                            <fieldset>
                                <!-- Start photo profil -->
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <input type="text" name="nom_parent" minlength="2" placeholder="Veuillez saisir le nom du parent ou tuteur"
                                                    class="form-control input-height" value="{{ old('nom_parent') }}" required />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <input type="text" name="prenom_parent" minlength="4" placeholder="Veuillez saisir le prénom du parent ou tuteur"
                                                    class="form-control input-height" value="{{ old('prenom_parent') }}"required />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <fieldset>
                                <div class="col-lg-12 p-t-20">
                                    <!--Start frais de réincription -->
                                        <div class="form-group row">
                                            <label class="control-label col-md-3">@lang('create.Frais_Reinscription')
                                                 <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control input-height"
                                                        name="frais_reinscription" placeholder="Veuillez saisir les frais de réinscription" value="{{ old('frais_reinscription') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    <!-- End frais de réinscription -->
                                    <!--Start arriéré -->
                                    <div class="form-group row">
                                        <label class="control-label col-md-3">@lang('create.Arrierer')
                                             <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control input-height"
                                                    name="montant_arrierer" placeholder="Veuillez saisir" value="0" required>
                                            </div>
                                        </div>
                                    </div>
                                <!-- End arriéré -->
