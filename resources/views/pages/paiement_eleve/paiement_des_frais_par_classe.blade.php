...
@section('content')
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Paiement Des Frais Scolaire De La {{ $classe->nom_niveau.' '.$classe->options }}</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="active">Paiement Des Frais Scolaire De La {{ $classe->nom_niveau.' '.$classe->options }}</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-topline-red">
                <div class="card-head">
                    <header>Paiement Des Frais Scolaire De La {{ $classe->nom_niveau.' '.$classe->options }}</header>
                    <div class="tools">
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                            <div class="btn-group">
                                ...
                                <a href="{{ route('etat_paiement_eleve') }}" class="btn btn-primary">
                                  Etat De Paiement Des Elèves  <i class="fa fa-money"></i>
                                </a>
                                &nbsp;&nbsp;&nbsp;
                                <button class="btn deepPink-bgcolor  btn-outline" data-toggle="modal" data-target="#emargement">Choisir Une Autre Classe Pour Effectuer Le Paiement
                            ...
                            <tbody>
                                ...
                                @foreach ($all_inscriptions as $inscription)
                                    ...
                                    @php
                                        ...
                                        // $scolarite_total = $scolarite_total +
                                    @endphp
                                @endforeach
                            </tbody>
                        </table>
                        <h3>
                            {{-- @dd($total_inscription + $total_reinscription) --}}
