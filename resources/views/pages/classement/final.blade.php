@extends($chemin_theme_actif,['title' => 'Final-Classement-Eleve'])
@section('content')
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Classement Annuel Des Elèves</div>
        </div>
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Classement Annuel Des Elèves</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card card-topline-red">
            <div class="card-head">
                <header>Classement Annuel Des Elèves De La {{ $niveau_choisi->nom_niveau.' '.$niveau_choisi->options }}</header>
                <div class="tools">
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-6">
                        ...
                        <input type="button" class="btn btn-primary" onclick="printDiv('imprime')" value="Imprimer le classement"/>
                    </div>
                    <div class="col-md-6 col-sm-6 col-6">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div  class="modal-header btn btn-danger text-center text-white">
                                            <h4 class="modal-title white-text w-100 font-weight-bold py-2">Classement</h4>
                ...
                <div class="col-md-12">
                        ...
                        <div class="mx-auto col-md-12 col-sm-12 col-lg-12">
                                <div class="text-center mx">
                                    <h4 class="text-center font-bold addr-font-h4">
                                        <u class="souligner">Classement Annuel Des élèves De La {{ $niveau_choisi->nom_niveau.' '.$niveau_choisi->options }}</u><br>
                                        <u class="souligner">
                                         Pour
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" id="bordure_table">
                                            ...
                                            @endphp
                                            @foreach ($classements as $classement)
                                                @if ($classement->eleve->sexe == 'Masculin' and $classement->moyenne >= $niveau_choisi->moyennee_admission)
                                                        @php
                                                            $nbre_garçon_admis++;
                                                        @endphp
                                                @endif
                                        ...
                                        <td class="text-center" id="bordure_table">
                                            ...
                                            @endphp
                                            @foreach ($classements as $classement)
                                                @if ($classement->eleve->sexe == 'Feminin' and $classement->moyenne >= $niveau_choisi->moyennee_admission)
                                                        @php
                                                            $nbre_fille_admis++;
                                                        @endphp
                                                @endif
                    ...
                    <div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <th class="text-center" id="bordure_table">Prénom Et Nom</th>
                            ...
                            <tbody id="bordure_table">
                                @foreach ($classements as $classement)
                                    <tr class="odd gradeX" id="bordure_table">
                                        ...
                                        <td class="text-center" id="bordure_table">{{ $classement->eleve->matricule }}</td>
                                        ...
                                        <td class="text-center" id="bordure_table">{{ floor($classement->moyenne * 100)/100 }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
