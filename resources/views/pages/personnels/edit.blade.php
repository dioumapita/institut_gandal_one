{{--  on herite du chemin du theme actif --}}
    @extends($chemin_theme_actif,['title' => 'Personnel-Edit'])
        @section('content')
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Modification Des Informations D'un Personnel</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Modification Des Informations D'un Personnel</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        <div class="card-head">
                            <header>Modification Des Informations D'un Personnel</header>
                        ...
                        <div class="card-body" id="bar-parent">
                            <form method="POST" action="{{ route('Personnel.update',$personnel->id) }}"  class="form-horizontal">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <div class="form-body">
                                    <!--Start Nom -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="nom" id="nom" placeholder="Entrez le nom"
                                                    value="{{ old('nom')?old('nom'):$personnel->nom }}" class="form-control @error('nom')is-invalid @enderror" required/>
                                                   @error('nom')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="prenom" id="prenom" placeholder="Entrez le prénom"
                                                    value="{{ old('prenom')?old('prenom'):$personnel->prenom }}" class="form-control @error('prenom')is-invalid @enderror" required/>
                                                @error('prenom')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong id="msg_error_profil">{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="poste" id="poste" placeholder="Entrez le poste de travail"
                                                    value="{{ old('poste')?old('poste'):$personnel->poste }}" class="form-control @error('poste')is-invalid @enderror" required/>
                                                @error('poste')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong id="msg_error_profil">{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="telephone" id="telephone" placeholder="Entrez le numéro de télephone"
                                                    value="{{ old('telephone')?old('telephone'):$personnel->telephone }}" class="form-control @error('telephone')is-invalid @enderror" required/>
                                                @error('telephone')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong id="msg_error_profil">{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="quartier" id="quartier" placeholder="Entrez le quartier"
                                                    value="{{ old('quartier')?old('quartier'):$personnel->quartier }}" class="form-control @error('quartier')is-invalid @enderror" required/>
                                                @error('quartier')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong id="msg_error_profil">{{ $message }}</strong>
                                                        </span>
